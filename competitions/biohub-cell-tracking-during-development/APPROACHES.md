...
| 2026-08-01 | Exp164 bidirectional crossing repair | Exp148 plus conservative pair swaps scored with predecessor and successor trajectory context | v1: 5,842 pairs, 0 accepted. v2 widened to `0.3 um` / `0.95`: still 0 proposals and 0 accepted; exact output unchanged | Diagnostic only; not submitted | The rule remains inactive even after widening; this may be a cost formulation issue rather than a lack of crossings | Instrument best feasible improvement/ratio before another rerun |
