...
| 2026-07-31 | Exp163 ambiguity-gated association | Learned bonus 1.0 to 3.0 only when top two geometric parent costs are within 0.75 um; 1,656 ambiguous targets; 637 edges replaced | Exact output harness passed | Pending (`55141367`) | Valid bounded main-graph intervention; edge Jaccard 0.9892 versus Exp148 | Compare LB before choosing stronger/weaker ambiguity bracket |
