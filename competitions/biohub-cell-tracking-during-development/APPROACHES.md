...
| 2026-07-16 | Exp091 density gap + adaptive short-track rescue | `notebooks/biohub-exp091-density-plus-short-track-rescue-candidate.ipynb` | Kaggle v1 running as `dalloliogm/biohub-exp091-short-track-rescue`; density gap retained, short-track rescue enabled | If complete and structurally valid, submit as one of the last daily slots |
| 2026-07-16 | Exp092 threshold 0.96875 + density gap | `notebooks/biohub-exp092-threshold-plus-density-gap-candidate.ipynb` | Kaggle v1 running as `dalloliogm/biohub-exp092-threshold-plus-density-gap-candidate`; combines Exp084 threshold with Exp090 density gap | If complete and structurally valid, submit as one of the last daily slots |
