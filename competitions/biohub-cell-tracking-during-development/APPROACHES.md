...
| 2026-07-19 | Exp110 ILP birth/death costs | `notebooks/biohub-exp110-ilp-birth-death-cost-candidate.ipynb` | Prepared; local Python syntax checks passed. Exp092-family TTA was already active, so this isolates ILP appearance/disappearance weights `0.0` / `1.4` under the existing TTA detector and Exp092 graph post-processing. | Upload/run on Kaggle T4; submit only after structural harness passes |
