...
| 2026-07-18 | Exp105 weighted gap-node interpolation | `notebooks/biohub-exp105-weighted-gap-interpolation-candidate.ipynb` | Prepared locally; syntax checks passed; adds motion-aware synthetic gap-node placement with `0.5` blend and `4.0 um` clamp on the Exp092 branch | Upload/run next |
