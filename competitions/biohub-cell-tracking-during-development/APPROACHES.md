...
| 2026-08-01 | Exp164 bidirectional crossing repair | Exp148 plus conservative pair swaps scored with predecessor and successor trajectory context | Synthetic crossing test passed; Kaggle v1 running | Pending | First association experiment to use future as well as past motion | Inspect accepted swaps; submit only if 20-2,000 edges change and exact checks pass |
