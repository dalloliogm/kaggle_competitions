...
| 2026-07-18 | Exp107 density gain 0.0475 | `notebooks/biohub-exp107-density-gain-0475-candidate.ipynb` | Kaggle v1 running as `dalloliogm/biohub-exp107-density-gain-0475`; Exp092 branch with only `BIOHUB_GAP_DENSITY_GAIN=0.0475` | Download/validate output, then submit if structural checks pass |
