...
- 2026-07-28: checked the "physics" notebook (`evgendvorkin/roggi-physics-lb-7-872-v48`) the user asked about — it's the SAME `vp_balanced_modelpkg_005` pipeline we run + the Q0522 landmine (will crash at grading). Nothing new to learn; don't submit it. Full analysis in `APPROACHES.md` (Tried).
